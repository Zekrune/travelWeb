...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function disableForm() {
        // 폼 요소들을 읽기 전용으로 변경
        const formElements = reviewForm.querySelectorAll('input, textarea, button[type="submit"]');
        ...
        if (photoInput) {
            ...
            document.querySelector('.custom-file-upload').style.pointerEvents = 'none';
        }
    }
